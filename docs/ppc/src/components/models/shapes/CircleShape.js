...
export class CircleShape extends Shape {
    ...
    draw(x, y) {
        ...
        if (this.type == "puck") {
            ...
            noFill();
            strokeWeight(12);
            stroke(this.currentColor.levels[0], this.currentColor.levels[1], this.currentColor.levels[2], this.glowAlpha - 50);
            this.drawSegmentedRing(0, 0, this.radius * 2.8, 8, PI / 6);

            strokeWeight(10);
            stroke(this.currentColor.levels[0], this.currentColor.levels[1], this.currentColor.levels[2], this.glowAlpha);
            this.drawSegmentedRing(0, 0, this.radius * 2.3, 10, PI / 10);

            // ** Inner Glow Rings (Neon Flicker Effect) **
            strokeWeight(6);
            stroke(this.currentColor.levels[0], this.currentColor.levels[1], this.currentColor.levels[2], this.glowAlpha + random(-20, 20));
            ...
            for (let i = 0; i < numArcs; i++) {
                ...
                stroke(this.currentColor.levels[0], this.currentColor.levels[1], this.currentColor.levels[2], this.glowAlpha + random(-30, 30));
    ...
    drawGlowingHexagon(x, y, hexRadius) {
        ...
        drawingContext.shadowColor = this.currentColor;
        strokeWeight(8);
        stroke(this.currentColor.levels[0], this.currentColor.levels[1], this.currentColor.levels[2], 80);
        noFill();
        beginShape();
        for (let i = 0; i < 6; i++) {
        ...
        fill(this.currentColor.levels[0], this.currentColor.levels[1], this.currentColor.levels[2], 200);
