 ...
 * Provides methods to detect collisions between different shapes:
 * - circleToRect: Detects collisions between a circle and rectangle
 * - rectToRect: Uses AABB method for rectangle-to-rectangle collisions
 * - circleToCircle: Advanced continuous collision detection between circles,
 *   with optimizations and sub-step checking to prevent tunneling
 */
